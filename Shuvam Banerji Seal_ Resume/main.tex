...
\begin{itemize}[leftmargin=*,label={},itemsep=4pt]
    \resumeSubheading{Web Development for Anicon 3.0}{2024-2025}
    {Inquivesta XI}{IISER Kolkata}
    \denseList{\small{
            \vspace{-5pt}
        \item Developed and leaded the web development of Anicon 3.0 Event. \href{https://anicon3.github.io/}{\faGlobe}
    }}
    \vspace{-3pt}
        \resumeSubheading{Web Development for EFAML}{2025}
    {Inquivesta XI}{IISER Kolkata}
    \denseList{\small{
            \vspace{-5pt}
        \item Developed and designed the researchers lab info page available under Dr. Soumyajit Roy's homepage.  \href{https://shuvam-banerji-seal.github.io/EFAML_WEB/index.html}{\faGlobe}
    }}
        \vspace{-3pt}
