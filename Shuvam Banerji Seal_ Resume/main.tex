...
\begin{itemize}[leftmargin=*,label={},itemsep=4pt]
    ...
    \resumeProject{Developing a complete GUI full-stack application using GTK4 in C}{2024 (ongoing)}
    ...
    \resumeProject{Porting the SMC Canteen system for IISER-Kolkata to Python3 Django}{2024 (ongoing)}
...
\begin{itemize}[leftmargin=0.15in,label={},itemsep=2pt]
    ...
    \skillBlock{Python Libraries:}{Numpy | Pandas | Matplotlib | Tensorflow | Transformers | NLTK | Spacy | Plotly | Manim}
    ...
    \skillBlock{Development Stack}{Full Stack (HTML/CSS/Javascript) | Databases (MongoDB, MySQL, SQLite3) | Version Control (Git) | Containerization (Docker) | CMake | Make}
...
\begin{itemize}[leftmargin=*,label={},itemsep=4pt]
    ...
    \resumeSubheading{\href{https://statuscode-1.devfolio.co/}{StatusCode1} (Awarded 1st Rank in GIAN Track)}{2024}
 ...
 \vspace{4pt}
    \item \textbf{National Level Basic Sciences Competitions:}
