...
\begin{itemize}[leftmargin=*,label={},itemsep=4pt]
    ...
    \resumeProject{Hierarchical Opinion Classification with Large Language Models}{2025 (Accepted at \href{https://fire.irsi.org.in/fire/2025/home}{FIRE 2025})}
    {Independent Research with Co-authors: \href{https://alok-mishra6.github.io/}{Alok Mishra} and \href{https://utkarshaghosh.netlify.app/}{Utkarsha Ghosh}}
...
\begin{itemize}[leftmargin=*,label={},itemsep=4pt]
    ...
    \resumeProject{Technical Talk – Running and Optimising Local LLMs}{Aug 2025}
    {Slashdot Student Chapter, IISER Kolkata}
    {
        \item Delivered a hands-on session covering hardware setups, quantisation methods, embedding pipelines, vector databases, and practical optimisation techniques for local LLM deployment.
    }
