...
\begin{itemize}[leftmargin=*,label={},itemsep=2pt]
    \resumeProject{President, Slashdot - The Programming and Design Club}{Aug 2025 -- Present}
    {IISER Kolkata}
...
\begin{itemize}[leftmargin=*,label={},itemsep=4pt]
    ...
    \resumeProject{1st Prize (Rs.2,00,000) -- UIDAI Data Hackathon 2026 \href{https://event.data.gov.in/challenge/uidai-data-hackathon-2026/}{\faGlobe}}{Jan 2026}
    {Unique Identification Authority of India (UIDAI), NIC, MeitY, Government of India}
    {\item Awarded 1st Prize in the national-level hackathon for data-driven analysis of Aadhaar enrolment and update datasets, identifying meaningful patterns and predictive indicators for system improvements.}
